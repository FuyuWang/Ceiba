...
arch = '_4x'
rl_dir2 = '/home/wangfuyu/Desktop/DNN_ACC/Scheduler/RL_Simba/report/simba_arch{}_pe/sampled_episodes_32'.format(arch)
cosa_dir = '/home/wangfuyu/Desktop/DNN_ACC/Mapper/cosa/output_dir/simba_v3{}_pe'.format(arch)
...
for dnn in dnns:
    ...
    for i, layer_id in enumerate(layer_ids):
        ...
        print('rl2: ', rl_fitnesses2, rl_fitnesses2[-1] / rl_fitnesses2[0])
