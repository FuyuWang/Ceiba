...
class TimeloopEnv(object):
    ...
    def get_map_config(self, sol):
        ...
        return {'mapping': [{'factors': 'R=1 S=1 P=1 Q=1 N=1 K=1 C=1', 'permutation': 'RSPQNKC', 'target': 'Registers', 'type': 'temporal'}, {'bypass': ['Inputs', 'Outputs'], 'keep': ['Weights'], 'target': 'Registers', 'type': 'bypass'}, {'factors': 'R=3 S=3 P=1 Q=1 N=1 K=1 C=1', 'permutation': 'RSPQNKC', 'target': 'AccumulationBuffer', 'type': 'temporal'}, {'factors': 'R=1 S=1 P=1 Q=1 N=1 K=4 C=2', 'permutation': 'RSPQNKC', 'target': 'AccumulationBuffer', 'type': 'spatial'}, {'bypass': ['Inputs', 'Weights'], 'keep': ['Outputs'], 'target': 'AccumulationBuffer', 'type': 'bypass'}, {'factors': 'R=1 S=1 P=1 Q=1 N=1 K=1 C=1', 'permutation': 'RSPQNKC', 'target': 'WeightBuffer', 'type': 'temporal'}, {'bypass': ['Inputs', 'Outputs'], 'keep': ['Weights'], 'target': 'WeightBuffer', 'type': 'bypass'}, {'factors': 'R=1 S=1 P=1 Q=1 N=1 K=1 C=1', 'permutation': 'RSPQNKC', 'target': 'InputBuffer', 'type': 'temporal'}, {'factors': 'R=1 S=1 P=1 Q=1 N=1 K=4 C=1', 'permutation': 'RSPQNKC', 'target': 'InputBuffer', 'type': 'spatial'}, {'bypass': ['Weights', 'Outputs'], 'keep': ['Inputs'], 'target': 'InputBuffer', 'type': 'bypass'}, {'factors': 'R=1 S=1 P=7 Q=7 N=1 K=4 C=1', 'permutation': 'RSPQNKC', 'target': 'GlobalBuffer', 'type': 'temporal'}, {'factors': 'R=1 S=1 P=1 Q=1 N=1 K=8 C=128', 'permutation': 'RSPQNKC', 'target': 'GlobalBuffer', 'type': 'spatial'}, {'bypass': ['Weights'], 'keep': ['Inputs', 'Outputs'], 'target': 'GlobalBuffer', 'type': 'bypass'}, {'factors': 'R=1 S=1 P=1 Q=1 N=1 K=1 C=2', 'permutation': 'RSPQNKC', 'target': 'DRAM', 'type': 'temporal'}, {'bypass': [], 'keep': ['Inputs', 'Weights', 'Outputs'], 'target': 'DRAM', 'type': 'bypass'}]}
...
if __name__ == '__main__':
    ...
    timeloop = TimeloopEnv(config_path=timeloop_configfile_path, in_config_dir='../in_config', arch_file='arch_64x_pe',
