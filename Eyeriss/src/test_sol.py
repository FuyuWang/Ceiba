...
class TimeloopEnv(object):
    ...
    def get_map_config(self, sol):
        ...
        return {'mapping': [{'factors': 'R=1 S=1 P=1 Q=7 C=1 K=1 N=4', 'permutation': 'RSPQCKN', 'target': 'Registers', 'type': 'temporal'}, {'factors': 'R=1 S=1 P=1 Q=1 C=1 K=16 N=1', 'permutation': 'RSPQCKN', 'target': 'AccumulationBuffer', 'type': 'spatial'}, {'factors': 'R=3 S=3 P=1 Q=1 C=8 K=4 N=1', 'permutation': 'RSPQCKN', 'target': 'AccumulationBuffer', 'type': 'temporal'}, {'factors': 'R=1 S=1 P=1 Q=1 C=1 K=1 N=1', 'permutation': 'RSPQCKN', 'target': 'WeightBuffer', 'type': 'temporal'}, {'factors': 'R=1 S=1 P=2 Q=1 C=1 K=2 N=1', 'permutation': 'RSPQCKN', 'target': 'InputBuffer', 'type': 'spatial'}, {'factors': 'R=1 S=1 P=1 Q=1 C=1 K=1 N=1', 'permutation': 'RSPQCKN', 'target': 'InputBuffer', 'type': 'temporal'}, {'factors': 'R=1 S=1 P=1 Q=2 C=16 K=2 N=1', 'permutation': 'RSPQCKN', 'target': 'GlobalBuffer', 'type': 'spatial'}, {'factors': 'R=1 S=1 P=1 Q=1 C=1 K=1 N=1', 'permutation': 'RSPQCKN', 'target': 'GlobalBuffer', 'type': 'temporal'}, {'factors': 'R=1 S=1 P=7 Q=1 C=2 K=1 N=2', 'permutation': 'RSPQCKN', 'target': 'DRAM', 'type': 'temporal'}, {'bypass': ['Inputs', 'Outputs'], 'keep': ['Weights'], 'target': 'Registers', 'type': 'bypass'}, {'bypass': ['Weights', 'Inputs'], 'keep': ['Outputs'], 'target': 'AccumulationBuffer', 'type': 'bypass'}, {'bypass': ['Inputs', 'Outputs'], 'keep': ['Weights'], 'target': 'WeightBuffer', 'type': 'bypass'}, {'bypass': ['Weights', 'Outputs'], 'keep': ['Inputs'], 'target': 'InputBuffer', 'type': 'bypass'}, {'bypass': ['Weights'], 'keep': ['Inputs', 'Outputs'], 'target': 'GlobalBuffer', 'type': 'bypass'}, {'bypass': [], 'keep': ['Weights', 'Inputs', 'Outputs'], 'target': 'DRAM', 'type': 'bypass'}]}
...
if __name__ == '__main__':
    ...
    timeloop = TimeloopEnv(config_path=timeloop_configfile_path, in_config_dir='../in_config', arch_file='arch_4x',
